...
import (
	"fmt"
	"github.com/zhangzw001/learnGee/7-panic-recover/gee"
	"github.com/zhangzw001/learnGee/7-panic-recover/middleware"
	"html/template"
	"net/http"
	"time"
)
...
func InitRouter() *gee.Engine {
	...
	e.Use(middleware.Logger(),gee.Recovery())
	...
	e.LoadHTMLGlob("7-panic-recover/templates/*")
	e.Static("/assets","7-panic-recover/static")
